...
TEST(TBitField, can_clear_already_cleared)
{
    TBitField bf(10);
...
TEST(TBitField, or_operator_applied_to_bitfields_in_a_row)
{
    ...
    EXPECT_EQ(expBf, bf3 | bf1 | bf2);
    EXPECT_EQ(expBf, bf2 | bf3 | bf1);
}
